                ...
                <div className='flex items-center gap-4 md:gap-7 '>
                    ...
                    <div className='text-slate-800' onClick={handleShowMenu}>
                        ...
                        <div className='absolute right-2 bg-white py-2 shadow drop-shadow-md flex flex-col'>
                            ...
                            {
                              userData.image ? <p className='cursor-pointer text-white px-2 bg-green-500' onClick={handleLogout}>Logout</p> : <Link to={"login"} className='whitespace-nowrap cursor-pointer px-2'>Login</Link>
                            }
